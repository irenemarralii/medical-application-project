...
---
This notebook loads the baseline and longitudinal datasets, perfroms basic integrity checks (IDs/duplicates),  recodes key variables, and saves cleaned objects for downstream notebooks.
...
# Force working directory to the RStudio Project root
...
saveRDS(baseline, "data/processed/baseline_clean.rds")
saveRDS(long, "data/processed/long_clean.rds")

cat("Saved cleaned datasets in data/processed/\n")
```
```{r}
getwd()
